...
then
    ...
    echo "e.g. 'led.sh' c 1 on    # turns colour zone 1 on"
    echo "     'led.sh' c 1 b 7   # set color zone 1 brightness to level 7"
    echo "     'led.sh' c 1 c red # set color zone 1 color to red "
    exit "1"
fi
